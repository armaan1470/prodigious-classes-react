    ...
    <>
      <footer className="footer">
          ...
          <div className="footer_top_row">
            <div className="footer_top_column footer_first_top_column">
              ...
              <div className="footer_detail_text footer_logo_text">
                We bring you a world-class team of highly experienced and
                qualified faculty
              </div>
            </div>
            <div className="footer_top_column padding_right">
              <div className="footer_heading_text">Quick Links</div>
              <div className="footer_detail_text">
                <ul className="footer_links_list">
                  <li className="footer_links">
                    <NavLink to="intro-ib">IB Tuition</NavLink>
                  </li>
                  <li className="footer_links">
                    <NavLink to="about-ig">IGCSE Tuition</NavLink>
                  </li>
                  <li className="footer_links">
                    <NavLink to="ASlevel">AS & A Levels Tuition</NavLink>
                  </li>
                  <li className="footer_links">
            ...
            <div className="footer_top_column footer_supp_col">
              <div className="footer_heading_text">Support</div>
              <div className="footer_detail_text">
                <ul className="footer_links_list">
                  <li className="footer_links">
                    <NavLink to="contact">Enquiry</NavLink>
                  </li>
                  <li className="footer_links">
                  ...
                  <li className="footer_links">
                    <NavLink to="contact">Sitemap</NavLink>
                  </li>
                  <li className="footer_links">
            ...
            <div className="footer_top_column last_colum_footer">
              <div className="footer_last_row_top">
                <div className="footer_heading_text">Have Questions?</div>
                <div className="footer_detail_text">
                  <div className="footer_icon_text_container">
                    <FiPhone
                      size={15}
                      color="#ebecee"
                      className="footer_icon_text_img"
              ...
              <div className="footer_last_row_bottom">
                <div className="footer_heading_text">Follow Us</div>
                <div className="footer_icons_container">
                  <a href="https://www.facebook.com/profile.php?id=100086078512350">
                    <FaFacebook
                      size={25}
                      color="#ebecee"
                      className="each_icon fb_icon"
                    />
                  </a>
        ...
        <div className="footer_bottom_container">
          <div className="bottom_text_copyright">
            Copyright &copy; 2023 Philomathean Carrer Institute. All Rights
            Reserved
          </div>
        </div>
      </footer>
